...
<body>
    <div class="dashboard">
        ...
        <section class="card">
            ...
            <a href="../Admin/create_hr.php"><button>Create HR Staff Account</button></a>
            <a href="../Admin/update_hr.php"><button>Update HR Staff Account</button></a>
            <a href="../Admin/delete_hr.php"><button>Delete HR Staff Account</button></a>
        </section>
