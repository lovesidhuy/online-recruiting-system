...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['form_type'])) {
    switch ($_POST['form_type']) {
        case 'update_info':
            $applicantModel->updateApplicantInfo($applicant_id,$_POST['first_name'],$_POST['last_name'],$_POST['email'],$_POST['phone_number'],$_POST['dob']);
            break;
        case 'add_education':
            $eduModel->addEducation($applicant_id, $_POST['degree'], $_POST['institution'], $_POST['start_year'], $_POST['end_year']);
            break;
        case 'delete_education':
            $eduModel->deleteEducation($_POST['education_id']);
            break;
        case 'add_experience':
            $expModel->addExperience($applicant_id, $_POST['company_name'], $_POST['job_title'], $_POST['start_date'], $_POST['end_date'], $_POST['description']);
            break;
